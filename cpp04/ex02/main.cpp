...
/*   Updated: 2025/10/10 11:36:32 by aarie-c2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main() {
    //Animal a; //this will give a compiling error
    std::cout << "---- Test: Polymorphic Array ----" << std::endl;
    const int N = 6;
    Animal* animals[N];
    /*Each element animals[i] is a pointer variable 
    (uninitialized by default) capable of pointing to an 
    Animal object or object of a derived class.
    It does not allocate or construct any Animal objects.
    */
